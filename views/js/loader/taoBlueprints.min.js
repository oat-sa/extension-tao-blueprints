...
helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers);var stack1,Handlebars="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing,self=this;function program6(depth0,data,depth1){var stack1,buffer="";return buffer+="\n            "+escapeExpression(typeof(stack1=null==(stack1=null==(stack1=depth1&&depth1.data)||!1===stack1?stack1:stack1.property)||!1===stack1?stack1:stack1.label)===functionType?stack1.apply(depth0):stack1)+" "+escapeExpression((stack1={hash:{},data:data},(data=helpers.__||depth1&&depth1.__)?data.call(depth0,"has no resources.",stack1
):helperMissing.call(depth0,"__","has no resources.",stack1)))+"\n        "}function program8(depth0,data){var helper,buffer="";return buffer+="\n            "+escapeExpression((data={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"No property defined, please select a property.",data):helperMissing.call(depth0,"__","No property defined, please select a property.",data)))+"\n        "}return Handlebars+='<section class="distributor">\n    ',!(stack1=helpers.if.call(depth0,null==(stack1=null==(stack1=depth0&&depth0.data)||!1===stack1?stack1:stack1.property)||!1===stack1?stack1:stack1.label,{hash:{},inverse:self.noop,
fn:self.program(1,function(depth0,data){var stack1,buffer="";return buffer+='\n    <header class="row">\n        <div class="label">'+escapeExpression(typeof(stack1=null==(stack1=null==(stack1=depth0&&depth0.data)||!1===stack1?stack1:stack1.property)||!1===stack1?stack1:stack1.label)===functionType?stack1.apply(depth0):stack1)+'</div>\n        <div class="count">'+escapeExpression((stack1={hash:{},data:data},(data=helpers.__||depth0&&depth0.__)?data.call(depth0,"Item Count",stack1):helperMissing.call(depth0,"__","Item Count",stack1)))+"</div>\n    </header>\n    "},data=data||{}),data:data}))&&0!==stack1||(Handlebars+=stack1),Handlebars+="\n    <ul>\n    ",
!(stack1=helpers.each.call(depth0,null==(stack1=depth0&&depth0.data)||!1===stack1?stack1:stack1.selection,{hash:{},inverse:self.programWithDepth(5,function(depth0,data,depth1){var buffer="";return buffer+='\n        <li class="empty"><em>\n        ',!(depth1=helpers.if.call(depth0,null==(depth1=null==(depth1=depth1&&depth1.data)||!1===depth1?depth1:depth1.property)||!1===depth1?depth1:depth1.label,{hash:{},inverse:self.program(8,program8,data),fn:self.programWithDepth(6,program6,data,depth0),data:data}))&&0!==depth1||(buffer+=depth1),buffer+="\n        </em></li>\n    "},data,depth0),fn:self.programWithDepth(3,function(depth0,data,depth1){var stack1,helper,
...
"css!taoBlueprintsCss/distributor.css"],function($,_,__,component,incrementer,template){"use strict";var defaultConfig={width:"auto",height:300,min:0,max:99};return function($container,config){var distributor=component({getValues:function(){var $component,self=this,values={};return this.is("rendered")&&($component=this.getElement(),$(".row",$component).each(function(){var $elt=$(this),$input=$(":text",$elt),$elt=$elt.data("uri");$elt&&1===$input.length&&self.config.data.selection[$elt]&&(values[$elt]={label:self.config.data.selection[$elt].label,value:$input.val()})})),values}},defaultConfig);return distributor.on("init",function(){this.render($container)}
).on("render",function(){var self=this,$component=this.getElement();$component.on("change",function(){self.trigger("change",self.getValues())}),incrementer($component)}).on("disable",function(){this.is("rendered")&&$(":text[data-increment]",this.getElement()).trigger("disable.incrementer")}).on("enable",function(){this.is("rendered")&&$(":text[data-increment]",this.getElement()).trigger("enable.incrementer")}),_.defer(function(){distributor.setTemplate(template).init(config)}),distributor}}),define("tpl!taoBlueprints/component/editor/propertySelector/selector",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){
this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers);var Handlebars="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing,self=this;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='\n        <a href="#" class="selected" data-uri="',stack1=(helper=helpers.uri)||typeof(helper=depth0&&depth0.uri)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1
)+"</a>\n        "}function program4(depth0,data){var helper,buffer="";return buffer+='\n        <a href="#" class="selected empty">'+escapeExpression((data={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Please select a property",data):helperMissing.call(depth0,"__","Please select a property",data)))+"</a>\n        "}return Handlebars+='<div class="property-selector">\n    ',!(depth0=helpers.if.call(depth0,depth0&&depth0.tree,{hash:{},inverse:self.program(6,function(depth0,data){var helper,buffer="";return buffer+='\n       <span class="txt-warning nothing">'+escapeExpression((data={hash:{},data:data},(
helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"No eligible property",data):helperMissing.call(depth0,"__","No eligible property",data)))+"</span>\n    "},data=data||{}),fn:self.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+="\n        ",!(stack1=helpers.if.call(depth0,depth0&&depth0.uri,{hash:{},inverse:self.program(4,program4,data),fn:self.program(2,program2,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n        <div class="options folded">\n            <ul>',!(stack1=(helper=helpers.tree)||typeof(helper=depth0&&depth0.tree)===functionType?helper.call(depth0,{hash:{},data:data}):helper)&&0!==stack1||(
buffer+=stack1),buffer+="</ul>\n        </div>\n    "},data),data:data}))&&0!==depth0||(Handlebars+=depth0),Handlebars+="\n</div>"})}),define("tpl!taoBlueprints/component/editor/propertySelector/listItem",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,Handlebars="",functionType="function",escapeExpression=this.escapeExpression;return Handlebars=(Handlebars=(Handlebars+='<li>\n    <a href="#" data-uri="')+(escapeExpression(stack1=(helper=helpers.uri)||typeof(helper=depth0&&depth0.uri
)===functionType?helper.call(depth0,{hash:{},data:data}):helper)+'">'))+(escapeExpression(stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper)+"</a>\n    "),!(stack1=helpers.if.call(depth0,depth0&&depth0.childList,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,buffer="";return buffer+="\n        <ul>\n            ",!(depth0=(helper=helpers.childList)||typeof(helper=depth0&&depth0.childList)===functionType?helper.call(depth0,{hash:{},data:data}):helper)&&0!==depth0||(buffer+=depth0),buffer+="\n        </ul>\n    "},data),data:data}))&&0!==stack1||(
Handlebars+=stack1),Handlebars+="\n</li>"})}),define("css!taoBlueprintsCss/property-selector",[],function(){}),define("taoBlueprints/component/editor/propertySelector/selector",["jquery","lodash","ui/component","tpl!taoBlueprints/component/editor/propertySelector/selector","tpl!taoBlueprints/component/editor/propertySelector/listItem","css!taoBlueprintsCss/property-selector.css"],function($,_,component,selectorTpl,listItemTpl){"use strict";return function($container,config){var propertySelector=component({getSelected:function(){var $component=this.getElement(),$component=$(".selected",$component);return!(!$component.length||$component.hasClass("empty"))&&{
label:$component.text(),uri:$component.data("uri")}}},{});return propertySelector.setTemplate(selectorTpl).on("init",function(){this.render($container)}).on("render",function(){var self=this,$component=this.getElement(),$selected=$(".selected",$component),$options=$(".options",$component);$selected.on("click",function(e){e.preventDefault(),$options.toggleClass("folded")}),$options.on("click","a",function(e){var $target=$(this),label=$target.text(),$target=$target.data("uri");e.preventDefault(),$selected.text(label).data("uri",$target),$options.toggleClass("folded"),self.trigger("change",$target,label)})}),_.defer(function(){var data;config.data&&0<_.size(
config.data)&&(config.tree=(data=config.data,_.reduce(data,function nodeToListItem(acc,node){var item=_.pick(node,["uri","label"]);return node.children&&node.children.length&&(item.childList=_.reduce(node.children,nodeToListItem,"")),acc+=listItemTpl(item)},""))),propertySelector.init(config)}),propertySelector}}),define("tpl!taoBlueprints/component/editor/editor",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"];var helper,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,escapeExpression=this.escapeExpression;
return buffer+='<section class="blueprint-editor form-content">\n    <div class="form-row">\n        <label for="label">'+escapeExpression((Handlebars={hash:{},data:data=data||{}},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Target Property",Handlebars):helperMissing.call(depth0,"__","Target Property",Handlebars)))+'</label>\n        <div class="property-selector-container"></div>\n    </div>\n    ',!(helper=helpers.if.call(depth0,null==(helper=depth0&&depth0.data)||!1===helper?helper:helper.availableProperties,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,buffer="";
return buffer+='\n    <div class="distributor-container"></div>\n    <div class="controls">\n        <button class="btn-info small saver"><span class="icon-save"></span> '+escapeExpression((data={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Save",data):helperMissing.call(depth0,"__","Save",data)))+"</button>\n    </div>\n    "},data),data:data}))&&0!==helper||(buffer+=helper),buffer+="\n</section>"})}),define("css!taoBlueprintsCss/editor",[],function(){}),define("taoBlueprints/component/editor/editor",["jquery","lodash","i18n","ui/component","taoBlueprints/component/editor/distributor/distributor",
...
,define("taoBlueprints/controller/Blueprints/editInstance",["jquery","i18n","layout/loading-bar","ui/feedback","taoBlueprints/provider/editor","taoBlueprints/component/editor/editor"],function($,__,loadingBar,feedback,editorProvider,editorComponent){"use strict";function onError(err){feedback().error(err.message),loadingBar.stop()}var provider=editorProvider();return{start:function(){var $editorContainer=$(".blueprint-editor-container"),uri=$editorContainer.data("uri");$editorContainer.length&&uri&&(loadingBar.start(),provider.get(uri).then(function(data){editorComponent($editorContainer,{data:data}).on("render",function(){loadingBar.stop()}).on(
