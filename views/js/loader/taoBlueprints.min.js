...
this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,buffer="",functionType="function",escapeExpression=this.escapeExpression,helperMissing=helpers.helperMissing,self=this;function program2(depth0,data){var stack1,helper,buffer="";return buffer+='\n        <a href="#" class="selected" data-uri="',stack1=(helper=helpers.uri)||typeof(helper=depth0&&depth0.uri)===functionType?helper.call(depth0,{hash:{},data:data}):helper,buffer+=escapeExpression(stack1)+'">',stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper,
buffer+=escapeExpression(stack1)+"</a>\n        "}function program4(depth0,data){var helper,options,buffer="";return buffer+='\n        <a href="#" class="selected empty">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Please select a property",options):helperMissing.call(depth0,"__","Please select a property",options)))+"</a>\n        "}return buffer+='<div class="property-selector">\n    ',!(stack1=helpers.if.call(depth0,depth0&&depth0.tree,{hash:{},inverse:self.program(6,function(depth0,data){var helper,options,buffer=""
;return buffer+='\n       <span class="txt-warning nothing">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"No eligible property",options):helperMissing.call(depth0,"__","No eligible property",options)))+"</span>\n    "},data),fn:self.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+="\n        ",!(stack1=helpers.if.call(depth0,depth0&&depth0.uri,{hash:{},inverse:self.program(4,program4,data),fn:self.program(2,program2,data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+='\n        <div class="options folded">\n            <ul>',!(stack1=(helper=helpers.tree)||typeof(
helper=depth0&&depth0.tree)===functionType?helper.call(depth0,{hash:{},data:data}):helper)&&0!==stack1||(buffer+=stack1),buffer+="</ul>\n        </div>\n    "},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n</div>"})}),define("tpl!taoBlueprints/component/editor/propertySelector/listItem",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],helpers=this.merge(helpers,Handlebars.helpers),data=data||{};var stack1,helper,buffer="",functionType="function",escapeExpression=this.escapeExpression;return buffer+='<li>\n    <a href="#" data-uri="',buffer+=escapeExpression(
stack1=(helper=helpers.uri)||typeof(helper=depth0&&depth0.uri)===functionType?helper.call(depth0,{hash:{},data:data}):helper)+'">',buffer+=escapeExpression(stack1=(helper=helpers.label)||typeof(helper=depth0&&depth0.label)===functionType?helper.call(depth0,{hash:{},data:data}):helper)+"</a>\n    ",!(stack1=helpers.if.call(depth0,depth0&&depth0.childList,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var stack1,helper,buffer="";return buffer+="\n        <ul>\n            ",!(stack1=(helper=helpers.childList)||typeof(helper=depth0&&depth0.childList)===functionType?helper.call(depth0,{hash:{},data:data}):helper)&&0!==stack1||(buffer+=stack1)
...
;return!(!$selected.length||$selected.hasClass("empty"))&&{label:$selected.text(),uri:$selected.data("uri")}}},{});return propertySelector.setTemplate(selectorTpl).on("init",function(){this.render($container)}).on("render",function(){var self=this,$component=this.getElement(),$selected=$(".selected",$component),$options=$(".options",$component);$selected.on("click",function(e){e.preventDefault(),$options.toggleClass("folded")}),$options.on("click","a",function(e){var $target=$(this),label=$target.text(),uri=$target.data("uri");e.preventDefault(),$selected.text(label).data("uri",uri),$options.toggleClass("folded"),self.trigger("change",uri,label)})}),_.defer(
function(){var data;config.data&&0<_.size(config.data)&&(config.tree=(data=config.data,_.reduce(data,function nodeToListItem(acc,node){var item=_.pick(node,["uri","label"]);return node.children&&node.children.length&&(item.childList=_.reduce(node.children,nodeToListItem,"")),acc+=listItemTpl(item)},""))),propertySelector.init(config)}),propertySelector}}),define("tpl!taoBlueprints/component/editor/editor",["handlebars"],function(hb){return hb.template(function(Handlebars,depth0,helpers,partials,data){this.compilerInfo=[4,">= 1.0.0"],data=data||{};var stack1,helper,options,buffer="",helperMissing=(helpers=this.merge(helpers,Handlebars.helpers)).helperMissing,
escapeExpression=this.escapeExpression;return buffer+='<section class="blueprint-editor form-content">\n    <div class="form-row">\n        <label for="label">'+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Target Property",options):helperMissing.call(depth0,"__","Target Property",options)))+'</label>\n        <div class="property-selector-container"></div>\n    </div>\n    ',!(stack1=helpers.if.call(depth0,null==(stack1=depth0&&depth0.data)||!1===stack1?stack1:stack1.availableProperties,{hash:{},inverse:this.noop,fn:this.program(1,function(depth0,data){var helper,options,buffer=""
;return buffer+='\n    <div class="distributor-container"></div>\n    <div class="controls">\n        <button class="btn-info small saver"><span class="icon-save"></span> '+escapeExpression((options={hash:{},data:data},(helper=helpers.__||depth0&&depth0.__)?helper.call(depth0,"Save",options):helperMissing.call(depth0,"__","Save",options)))+"</button>\n    </div>\n    "},data),data:data}))&&0!==stack1||(buffer+=stack1),buffer+="\n</section>"})}),define("css!taoBlueprintsCss/editor",[],function(){}),define("taoBlueprints/component/editor/editor",["jquery","lodash","i18n","ui/component","taoBlueprints/component/editor/distributor/distributor",
